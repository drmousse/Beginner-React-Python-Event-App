...
import TestProducts from "./test-data.js";

import './test-component.scss';

export function TemplateDemo2() {
        ...
        return (
            <div className="col-10" key={product.id}>
                <div className={classNames('flex flex-column xl:flex-row xl:align-items-start p-4 gap-4', { 'border-top-1 surface-border': index !== 0 })}>
                    <img className="w-8 sm:w-10rem xl:w-10rem shadow-2 block xl:block mx-auto border-round" src={`https://primefaces.org/cdn/primereact/images/product/${product.image}`} alt={product.name} />
                    <div className="flex flex-column sm:flex-row justify-content-between align-items-center xl:align-items-start flex-1 gap-2">
                        ...
                        <div className="flex sm:flex-column align-items-center sm:align-items-end gap-3 sm:gap-2">
                            ...
                            <div className="flex flex-wrap justify-content-center gap-2">
                                ...
                                <Button icon="pi pi-shopping-cart" className="p-button-rounded flex align-items-center justify-content-center" disabled={product.inventoryStatus === 'OUTOFSTOCK'}></Button>
                                <Button icon="pi pi-shopping-cart" className="p-button-rounded flex align-items-center justify-content-center" disabled={product.inventoryStatus === 'OUTOFSTOCK'}></Button>
                                <Button icon="pi pi-shopping-cart" className="p-button-rounded flex align-items-center justify-content-center" disabled={product.inventoryStatus === 'OUTOFSTOCK'}></Button>
                                <Button icon="pi pi-shopping-cart" className="p-button-rounded flex align-items-center justify-content-center" disabled={product.inventoryStatus === 'OUTOFSTOCK'}></Button>
                                <Button icon="pi pi-shopping-cart" className="p-button-rounded flex align-items-center justify-content-center" disabled={product.inventoryStatus === 'OUTOFSTOCK'}></Button>
