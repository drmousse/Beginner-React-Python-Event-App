...
# custom imports
from .base import TioDB


# classes
class Counter(TioDB.db.Model):
    __tablename__ = 'tio_counter'
    __classname__ = 'tio_counter'

    counter_name = TioDB.db.Column(String(30), primary_key=True)
    value = TioDB.db.Column(Integer)
